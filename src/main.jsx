...
function App() {
  ...
  return <div className="app">
    ...
    <main id="top">
      ...
      <section className="flight-strip" id="route"><div><small>FLIGHT</small><b>KTPF <span>→</span> KTLH</b></div><div><small>DEPARTURE</small><b>SEP 2 · 6:00 PM ET</b></div><div><small>RULES / AIRCRAFT</small><b>VFR · C172</b></div><div><small>PILOT PROFILE</small><b>VFR ONLY</b></div><button onClick={runAssessment}>ASK AI TO CHECK ROUTE</button></section>
