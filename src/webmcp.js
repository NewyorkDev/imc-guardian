export const toolDefinitions = [
  ...
  ['configure_route_watch', 'Configure a focused demo route watch using user-defined ceiling or visibility thresholds, flight-category changes, or new advisories. These are personal attention thresholds, not published approach minimums.', { trigger: { type: 'string', enum: ['flight_category_worsens', 'ceiling_below_threshold', 'visibility_below_threshold', 'new_route_advisory'] }, ceilingThresholdFt: { type: 'number', minimum: 200, maximum: 10000 }, visibilityThresholdSm: { type: 'number', minimum: 0.25, maximum: 20 }, delivery: { type: 'string', enum: ['in_app', 'browser'] } }, ['trigger']],
