...
The site exposes the details pilots expect: METARs, ceilings, visibility, winds, TAF trends, advisories, alternatives, and the limits of the analysis. Apple WeatherKit also provides an on-demand live weather corridor from Tampa to JFK.
